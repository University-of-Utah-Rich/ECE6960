...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, A_Pin|B_Pin|C_Pin|NCS_MEMS_SPI_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, OE_Pin|STB_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin PCPin PCPin PCPin
                           PCPin */
  GPIO_InitStruct.Pin = A_Pin|B_Pin|C_Pin|NCS_MEMS_SPI_Pin
                          |EXT_RESET_Pin|LD3_Pin|LD6_Pin|LD4_Pin
                          |LD5_Pin;
  ...
  GPIO_InitStruct.Pin = OE_Pin|STB_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
